export var MapModel = (function () {
    ...
    MapModel.prototype.getMapConfig = function () {
        var mapOptions = {
            //  center: latLng,
    ...
    MapModel.prototype.getHeatMapConfig = function () {
        var heatmap = {
            radius: 50,
            dissipating: true,
    ...
    MapModel.prototype.groupBy = function (collection, property) {
    ...
    MapModel.prototype.interpolatePoints = function (points) {
        ...
        for (var i = 0; i < points.length; i++) {
            ...
            for (var j = 0; j < this.interpolationFactor; j++) {
                var newPoint = this.getRandomMarker(cityCircle.getBounds());
                var data = { location: newPoint, weight: points[i].weight };
                newPoints.push(data);
            }
        }
        return newPoints;
    };
    MapModel.prototype.getRandomMarker = function (bounds) {
        var lat_min = bounds.getSouthWest().lat(), lat_range = bounds.getNorthEast().lat() - lat_min, lng_min = bounds.getSouthWest().lng(), lng_range = bounds.getNorthEast().lng() - lng_min;
        return new google.maps.LatLng(lat_min + (Math.random() * lat_range), lng_min + (Math.random() * lng_range));
    };
    MapModel.prototype.distance = function (p1, p2) {
        //  return (google.maps.geometry.spherical.computeDistanceBetween(p1, p2) / 1000).toFixed(2); in km
        return google.maps.geometry.spherical.computeDistanceBetween(p1, p2);
    };
    MapModel.prototype.getDistanceFromLocationInMeters = function (point1, point2) {
        var lat1 = point1.lat;
        var lon1 = point1.lng;
        var lat2 = point2.lat;
        var lon2 = point2.lng;
    ...
    MapModel.prototype.deg2rad = function (deg) {
        return deg * (Math.PI / 180);
    };
    //filter a list, return the poinst inside of a radius given a center
    //points = [{location: latLng, weight: w}];
    MapModel.prototype.pointsInside = function (centerLatLng, radius, points) {
        var pointsInside = [];
        for (var i = 0; i < points.length; i++) {
            var p = points[i].location;
            var distanceIn = this.distance(centerLatLng, p);
    ...
    MapModel.prototype.addUserPosition = function (map, latLng) {
        var userPosition = { lat: latLng.lat(), lng: latLng.lng() };
    ...
    MapModel.prototype.addPointsToHeatmap = function (map, points) {
        var config = this.getHeatMapConfig();
        var heatmap = new google.maps.visualization.HeatmapLayer(config);
    ...
    //      radius: 100
    //    });
    MapModel.prototype.getGradientStyle = function () {
        var gradient = [
            'rgba(255,232,112, 0)',
            //'rgba(255,232,112, 1)',
            'rgba(254,217,118, 1)',
    ...
    MapModel.prototype.getDarkStyle = function () {
        return this.getStyle14();
    };
    MapModel.prototype.getStyle14 = function () {
        //light dream
        return [
            {
    ...
    MapModel.prototype.getStyle13 = function () {
        return [
            {
                "elementType": "labels",
                "stylers": [
    ...
    MapModel.prototype.getStyle12 = function () {
        //mymap
    ...
    MapModel.prototype.getStyle11 = function () {
    ...
    MapModel.prototype.getStyle10 = function () {
    ...
    MapModel.prototype.getStyle9 = function () {
        //Navigation
    ...
    MapModel.prototype.getStyle8 = function () {
    ...
    MapModel.prototype.getStyle7 = function () {
    ...
    MapModel.prototype.getStyle6 = function () {
    ...
    MapModel.prototype.getStyle5 = function () {
    ...
    MapModel.prototype.getStyle4 = function () {
    ...
    MapModel.prototype.getStyle3 = function () {
        //Shift Worker - bom
    ...
    MapModel.prototype.getStyle2 = function () {
        return [{ "featureType": "administrative", "elementType": "all", "stylers": [{ "saturation": "-100" }] }, { "featureType": "administrative.province", "elementType": "all", "stylers": [{ "visibility": "off" }] }, { "featureType": "landscape", "elementType": "all", "stylers": [{ "saturation": -100 }, { "lightness": 65 }, { "visibility": "on" }] }, { "featureType": "poi", "elementType": "all", "stylers": [{ "saturation": -100 }, { "lightness": "50" }, { "visibility": "simplified" }] }, { "featureType": "road", "elementType": "all", "stylers": [{ "saturation": "-100" }] }, { "featureType": "road.highway", "elementType": "all", "stylers": [{ "visibility": "simplified" }] }, { "featureType": "road.arterial", "elementType": "all", "stylers": [{ "lightness": "30" }] }, { "featureType": "road.local", "elementType": "all", "stylers": [{ "lightness": "40" }] }, { "featureType": "transit", "elementType": "all", "stylers": [{ "saturation": -100 }, { "visibility": "simplified" }] }, { "featureType": "water", "elementType": "geometry", "stylers": [{ "hue": "#ffff00" }, { "lightness": -25 }, { "saturation": -97 }] }, { "featureType": "water", "elementType": "labels", "stylers": [{ "lightness": -25 }, { "saturation": -100 }] }];
    };
    MapModel.prototype.getStyle1 = function () {
        return [
            {
                "elementType": "geometry",
                "stylers": [
